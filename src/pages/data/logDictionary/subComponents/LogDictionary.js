...
export default class LogDictionary extends Component {
  constructor(props) {
    super(props)
    this.state = {
      loading: true,
  ...
  getData() {
    ...
    actions.fetchLogDictionaryData(page, searchId, searchText, sorter, filByEnabled)
  }
  ...
  handleDelete(event) {
    ...
    confirm({
      ...
      cancelText: '取消',
      onOk() {
        actions.deleteLogDictionaryData(id, that.getData)
