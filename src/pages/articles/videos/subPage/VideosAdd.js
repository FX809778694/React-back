    ...
    return (
      <Card title='添加视频信息' bordered={true}>
        <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
          <InputItem label="视频标题" getFieldDecorator={getFieldDecorator} id="title" required={true}/>
          <TextAreaItem label="视频描述" getFieldDecorator={getFieldDecorator} id="description" required={true}/>
          <LanguageItem getFieldDecorator={getFieldDecorator} required={true}/>
          <TextAreaItem label="视频内容" getFieldDecorator={getFieldDecorator} id="content" required={true}/>
          ...
          <FeaturesItem label="视频属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue} setFieldsValue={setFieldsValue}/>
...
const VideosAdd = Form.create()(DataAdd);
...
export default connect(mapStateToProps, mapDispatchToProps)(VideosAdd)
