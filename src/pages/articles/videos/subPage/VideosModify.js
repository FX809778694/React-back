...
class DataModify extends Component {
  ...
  render() {
    ...
    return (
      <Card loading={loading} title={`视频修改 —— ${data.post && data.post.title}`} bordered={true}>
        { data.post &&
          <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
            <InputItem label="视频标题" getFieldDecorator={getFieldDecorator} id="title" initialValue={data.post.title} required={true}/>
            <TextAreaItem label="视频描述" getFieldDecorator={getFieldDecorator} id="description" initialValue={data.post.description} required={true}/>
            <LanguageItem getFieldDecorator={getFieldDecorator} initialValue={data.post.language} required={true}/>
            <TextAreaItem label="视频内容" getFieldDecorator={getFieldDecorator} id="content" initialValue={data.post.content} required={true}/>
            ...
            <FeaturesItem label="视频属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue}
            ...
            <CalendarItem label="发表时间" id="postDate" getFieldDecorator={getFieldDecorator} initialValue={data.created} onChangeData={this.onChangeData}/>
...
const VideosModify = Form.create()(DataModify);

VideosModify.PropTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(VideosModify)
