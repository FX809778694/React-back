...
class VideosDetail extends React.Component {
  constructor() {
    super();
    this.state = {
      loading: true
      ...
      <Card loading={loading} title={data.post && data.post.title} bordered={true}>
        { data &&
          <Form layout={'horizontal'}>
            ...
            <Items label="视频标题：" data={data.post && data.post.title}/>
            <Items label="视频描述：" data={data.post && data.post.description}/>
            ...
            <Items label="视频内容：" data={data.post &&
            ...
            <Items label="视频属性：" data={data.post &&
