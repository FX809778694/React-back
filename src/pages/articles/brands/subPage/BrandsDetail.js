      ...
      <Card loading={loading} title={data.post && data.post.title} bordered={true}>
        { data &&
          <Form layout={'horizontal'}>
            ...
            <Items label="品牌标题：" data={data.post && data.post.title}/>
            <Items label="品牌描述：" data={data.post && data.post.description}/>
            ...
            <Items label="品牌内容：" data={data.post &&
            ...
            <Items label="品牌属性：" data={data.post &&
            ...
            <Items label="品牌LOGO URL：" data={data.topicsBrand && data.topicsBrand.logo}/>
            <Items label="图片：" data={
...
export default connect(mapStateToProps, mapDispatchToProps)(BrandsDetail)
