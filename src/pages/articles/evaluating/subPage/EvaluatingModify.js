...
class DataModify extends Component {
  ...
  render() {
    ...
    return (
      <Card loading={loading} title={`评测修改 —— ${data.post && data.post.title}`} bordered={true}>
        { data.post &&
          <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
            <InputItem label="评测标题" getFieldDecorator={getFieldDecorator} id="title" initialValue={data.post.title} required={true}/>
            <TextAreaItem label="评测描述" getFieldDecorator={getFieldDecorator} id="description" initialValue={data.post.description} required={true}/>
            <LanguageItem getFieldDecorator={getFieldDecorator} initialValue={data.post.language} required={true}/>
            <ContentItem label="评测内容" getFieldDecorator={getFieldDecorator} initialValue={data.post.content} required={true}/>
            ...
            <FeaturesItem label="评测属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue}
...
const EvaluatingModify = Form.create()(DataModify);

EvaluatingModify.PropTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(EvaluatingModify)
