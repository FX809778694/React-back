...
class DataAdd extends Component {
  ...
  render() {
    ...
    return (
      <Card title='添加评测信息' bordered={true}>
        <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
          <InputItem label="评测标题" getFieldDecorator={getFieldDecorator} id="title" required={true}/>
          <TextAreaItem label="评测描述" getFieldDecorator={getFieldDecorator} id="description" required={true}/>
          <LanguageItem getFieldDecorator={getFieldDecorator} required={true}/>
          <ContentItem label="评测内容" getFieldDecorator={getFieldDecorator} required={true}/>
          ...
          <FeaturesItem label="评测属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue} setFieldsValue={setFieldsValue}/>
...
const EvaluatingAdd = Form.create()(DataAdd);

EvaluatingAdd.PropTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(EvaluatingAdd)
