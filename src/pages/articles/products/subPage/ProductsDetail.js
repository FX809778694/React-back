      ...
      <Card loading={loading} title={data.post && data.post.title} bordered={true}>
        { data &&
          <Form layout={'horizontal'}>
            ...
            <Items label="产品标题：" data={data.post && data.post.title}/>
            <Items label="产品描述：" data={data.post && data.post.description}/>
            ...
            <Items label="产品内容：" data={data.post &&
            ...
            <Items label="产品属性：" data={data.post &&
            ...
            <Items label="价格：" data={data.product && data.product.price}/>
            <Items label="价格单位：" data={data.product && data.product.priceUnit}/>
            <Items label="品牌名称：" data={data.product && data.product.brand}/>
            <Items label="图片：" data={
