...
class DataModify extends Component {
  ...
  render() {
    ...
    return (
      <Card loading={loading} title={`新闻修改 —— ${data.post && data.post.title}`} bordered={true}>
        { data.post &&
          <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
            <InputItem label="新闻标题" getFieldDecorator={getFieldDecorator} id="title" initialValue={data.post.title} required={true}/>
            <TextAreaItem label="新闻描述" getFieldDecorator={getFieldDecorator} id="description" initialValue={data.post.description} required={true}/>
            <LanguageItem getFieldDecorator={getFieldDecorator} initialValue={data.post.language} required={true}/>
            <ContentItem label="新闻内容" getFieldDecorator={getFieldDecorator} initialValue={data.post.content} required={true}/>
            ...
            <FeaturesItem label="新闻属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue}
...
const NewsModify = Form.create()(DataModify);

NewsModify.PropTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(NewsModify)
