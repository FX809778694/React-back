      ...
      <Card loading={loading} title={data.post && data.post.title} bordered={true}>
        { data &&
          <Form layout={'horizontal'}>
            ...
            <Items label="新闻标题：" data={data.post && data.post.title}/>
            <Items label="新闻描述：" data={data.post && data.post.description}/>
            ...
            <Items label="新闻内容：" data={data.post &&
            ...
            <Items label="新闻属性：" data={data.post &&
