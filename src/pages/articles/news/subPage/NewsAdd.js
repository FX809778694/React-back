...
class DataAdd extends Component {
  ...
  render() {
    ...
    return (
      <Card title='添加新闻信息' bordered={true}>
        <Form layout={'horizontal'} onSubmit={this.handleSubmit}>
          <InputItem label="新闻标题" getFieldDecorator={getFieldDecorator} id="title"  required={true}/>
          <TextAreaItem label="新闻描述" getFieldDecorator={getFieldDecorator} id="description" required={true}/>
          <LanguageItem getFieldDecorator={getFieldDecorator} required={true}/>
          <ContentItem label="新闻内容" getFieldDecorator={getFieldDecorator} required={true}/>
          ...
          <FeaturesItem label="新闻属性" getFieldDecorator={getFieldDecorator} getFieldValue={getFieldValue} setFieldsValue={setFieldsValue}/>
...
const NewsAdd = Form.create()(DataAdd);
